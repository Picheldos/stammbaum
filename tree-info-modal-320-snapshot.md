    ...
    - generic [ref=f8e5]:
      ...
      - main [ref=f8e17]:
        - generic [ref=f8e18]:
          - generic [ref=f8e60]:
            - generic:
              - button "Петрова Мария" [ref=f8e61] [cursor=pointer]:
                - generic [ref=f8e62]: Мать
                - generic [ref=f8e64]: 03.02.1955
              - button "Петров Пётр" [ref=f8e65] [cursor=pointer]:
                - generic [ref=f8e66]: Отец
                - generic [ref=f8e68]: 05.04.1950 — 07.06.2020
              - button "Петров Иван" [ref=f8e69] [cursor=pointer]:
                - generic [ref=f8e70]: Я
                - generic [ref=f8e72]: 01.01.1980
              - button "Петрова Анна" [ref=f8e73] [cursor=pointer]:
                - generic [ref=f8e74]: Жена
                - generic [ref=f8e76]: 09.08.1982
              - button "Петров Алексей" [ref=f8e77] [cursor=pointer]:
                - generic [ref=f8e78]: Сын
                - generic [ref=f8e80]: 11.10.2008
          ...
          - generic [ref=f8e113]:
            - generic [ref=f8e114]:
              - generic [ref=f8e115]: Петров Иван
              - button "close" [ref=f8e116] [cursor=pointer]: ×
            - generic [ref=f8e117]:
              - generic [ref=f8e120]:
                - generic [ref=f8e121]: Петров Иван
                - generic [ref=f8e122]: 01.01.1980
              - generic [ref=f8e123]:
                - button "Информация" [ref=f8e124] [cursor=pointer]
                - button "Родители" [ref=f8e125] [cursor=pointer]
                - button "Супруги" [ref=f8e126] [cursor=pointer]
                - button "Дети" [ref=f8e127] [cursor=pointer]
                - button "Братья и сёстры" [ref=f8e128] [cursor=pointer]
              - button "Редактировать" [ref=f8e131] [cursor=pointer]
    - generic [ref=f8e39]:
