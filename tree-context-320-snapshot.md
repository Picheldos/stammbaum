      ...
      - main [ref=f8e17]:
        - generic [ref=f8e18]:
          ...
          - form "Поиск" [ref=f8e97]:
            - searchbox "Поиск по фамилии или имени" [active] [ref=f8e98]: Несуществующий
          ...
          - menu "Person actions" [ref=f8e101]:
            - generic [ref=f8e102]:
              - generic [ref=f8e103]: Петров Иван
              - button "close" [ref=f8e104] [cursor=pointer]: ×
            - list [ref=f8e105]:
              - menuitem "Открыть карточку" [ref=f8e106] [cursor=pointer]
              - menuitem "Редактировать карточку" [ref=f8e107] [cursor=pointer]
              - menuitem "Добавить родственника" [ref=f8e108] [cursor=pointer]
              - menuitem "Посмотреть родственные связи" [ref=f8e109] [cursor=pointer]
              - menuitem "Скрыть родственника" [ref=f8e110] [cursor=pointer]
              - menuitem "Показать скрытых родственников" [ref=f8e111] [cursor=pointer]
    - generic [ref=f8e39]:
